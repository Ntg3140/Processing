...
void setup()
{
  ...
  multiple=second()-startTime;
  prevMultiple=second()-startTime;
  first=true;
  X=0;
  y=0;
  Y=0;
...
void draw()
{
  ...
  first=false;
  multiple=second()-startTime;
  currentTime=(60*minutes)+second()-startTime;
  ...
  if (multiple==0 && first==true && firstTime==false)
  {
    minutes+=1;
    firstTime=false;
    currentTime=(60*minutes)+second()-startTime;
  ...
  if (multiple<0)
  {
    currentTime=multiple+(60*(minutes+1));
  }
  else
  {
    currentTime=(60*minutes)+second()-startTime;
  ...
  println(floor(counter/60));
  text("Time: "+(counter/60),50,50);
  //first=false;
